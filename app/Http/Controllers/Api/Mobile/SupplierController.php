...
class SupplierController extends Controller
{
    ...
    public function index(Request $request, SupplierListQuery $listQuery)
    {
    ...
    public function store(Request $request, CreateSupplierAction $action)
    {
    ...
    public function update(Request $request, $id, UpdateSupplierAction $action)
    {
    ...
    public function destroy($id, DeleteSupplierAction $action)
    {
