...
class ExpenseController extends Controller
{
    ...
    public function index(Request $request, ExpenseListQuery $listQuery)
    {
    ...
    public function store(Request $request, CreateExpenseAction $action)
    {
    ...
    public function update(Request $request, $id, UpdateExpenseAction $action)
    {
